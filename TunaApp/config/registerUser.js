...
exports.registerUserCA = function (email){  //Added this function to call from users.js
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
    ...
    return fabric_ca_client.enroll({enrollmentID: email, enrollmentSecret: secret});
}).then((enrollment) => {
  console.log('Successfully enrolled member user' + email);
  return fabric_client.createUser(
     ...
     console.log(email +' was successfully registered and enrolled and is ready to intreact with the fabric network');
